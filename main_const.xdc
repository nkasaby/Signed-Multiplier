...
#LEDs
set_property PACKAGE_PIN U16 [get_ports endmult]
set_property IOSTANDARD LVCMOS33 [get_ports endmult]


#Buttons
set_property PACKAGE_PIN T17 [get_ports right_but]
set_property IOSTANDARD LVCMOS33 [get_ports right_but]

set_property PACKAGE_PIN W19 [get_ports left_but]
set_property IOSTANDARD LVCMOS33 [get_ports left_but]

set_property PACKAGE_PIN U18 [get_ports multiply_but]
set_property IOSTANDARD LVCMOS33 [get_ports multiply_but]
